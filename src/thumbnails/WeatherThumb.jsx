...
class WeatherThumb extends Component {
  constructor (props) {
    super(props);
    this.state = {};
    var options = {
...
renderWeatherToday () {
  ...
  if (temp) {
      var tempElm = <div className="big-temp-thumb">{temp}</div>;
  }

  return (
      <div className="weather-today-thumb">
        <div className="icon-wrapper-thumb">
            <div className={`icon-small-thumb ${icon}`}>
            </div>
        </div>
            {tempElm}
      </div>
...
renderDay (day, index) {
  ...
  if (temp) {
      var tempElm = <div className="small-temp-thumb">{temp}</div>;
  }
  ...
  return (
        <div className="day" key={index}>
            ...
            <div className="icon-wrapper-thumb">
                <div className={`icon-small-thumb ${getIcon(day.icon)}`}>
                </div>
                {tempElm}
            </div>
        </div>
